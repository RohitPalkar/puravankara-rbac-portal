...
import { mockChannelPartners } from 'src/services/mock-data';
...
export default function ChannelPartnerListPage() {
  ...
  const [data, setData] = useState<ChannelPartner[]>(mockChannelPartners);
      ...
      renderCell: (params) => (
        <Stack alignItems="center" sx={{ height: 1, justifyContent: 'center' }}>
          <RowActionsMenu actions={[
            { label: 'Edit', icon: 'solar:pen-bold', onClick: () => navigate(paths.dashboard.channelPartnerMasterEdit(params.row.id)) },
  ...
  return (
    <>
      ...
      <Dialog open={!!deleteId} onClose={() => setDeleteId(null)} maxWidth="xs">
        ...
        <DialogContent>Are you sure you want to delete this channel partner?</DialogContent>
        <DialogActions>
